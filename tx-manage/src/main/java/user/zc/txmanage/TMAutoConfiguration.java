...
import user.zc.txmanage.config.TxManagerConfig;
import user.zc.txmanage.core.storage.FastStorage;
import user.zc.txmanage.core.storage.FastStorageProvider;
import user.zc.txmanage.core.storage.redis.RedisStorage;
...
@EnableJpaRepositories("user.zc.txmanage.support.db.jpa")
@EntityScan("user.zc.txmanage.support.db.domain")
